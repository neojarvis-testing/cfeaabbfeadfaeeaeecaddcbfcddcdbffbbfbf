...
INSERT INTO `user` VALUES (1,'$2a$10$UpFhYm0scSEEWmWc0oAex.s5p2tN1l1/PLN.cXKa4Kq/.YDRHnJ1q','ADMIN','admin'),(2,'$2a$10$EUK1W.LZK/mepGhZXE3gE.fQDbPz52OEu64lJIQ.hJKhL9/OcwDGa','ADMIN','admin'),(3,'$2a$10$V.mw5QHYpyA5GJiafLoQF..rQMeCzl3hwLZvWk9bCo9hDYUsxo046','ADMIN','admin'),(4,'$2a$10$EsBXbXkC3D6kAclUpozH5.ZPBIflHCukrBm3EWPCABl9NELV6hPqe','ADMIN','admin'),(5,'$2a$10$ntdM1ATxchU3GSzextqBP.29kh2Q57haru75frYPWhYBApCTOmOTW','ADMIN','admin'),(6,'$2a$10$rTfeR5DyQhO.iwcL0FCnauk2S3f5D34RNwN1DkCWEZzG6GXsXWOvm','ADMIN','admin');
...
-- Dump completed on 2024-01-04 10:13:56
